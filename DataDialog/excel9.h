...
public:
	...
	CString GetStandardXFont();
	void SetStandardXFont(LPCTSTR lpszNewValue);
	double GetStandardXFontSize();
	void SetStandardXFontSize(double newValue);
...
public:
	...
	VARIANT AutoFit();
	VARIANT AutoFormat(long Format, const VARIANT& Number, const VARIANT& XFont, const VARIANT& Alignment, const VARIANT& Border, const VARIANT& Pattern, const VARIANT& Width);
	VARIANT AutoOutline();
...
class AFX_EXT_CLASS XFont : public COleDispatchDriver
{
public:
	XFont() {}		// Calls COleDispatchDriver default constructor
	XFont(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	XFont(const XFont& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	VARIANT GetName();
	void SetName(const VARIANT& newValue);
	VARIANT GetOutlineXFont();
	void SetOutlineXFont(const VARIANT& newValue);
	VARIANT GetShadow();
...
public:
	...
	LPDISPATCH AddTextEffect(long PresetTextEffect, LPCTSTR Text, LPCTSTR XFontName, float XFontSize, long XFontBold, long XFontItalic, float Left, float Top);
