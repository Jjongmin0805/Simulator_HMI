...
#ifndef _SKINHEADERCTRL_H
#define _SKINHEADERCTRL_H
...
#define SKINHEADERCTRL_NO_IMAGE			0
#define SKINHEADERCTRL_UNCHECKED_IMAGE	1
#define SKINHEADERCTRL_CHECKED_IMAGE	2
...
{
    DECLARE_DYNCREATE(CSkinHeaderCtrl)
