...
// 
bool SplitterCtrlBase::SaveState(CWinApp *app, TCHAR const *section, TCHAR const *entry)
...
// 
bool SplitterCtrlBase::LoadState(CWinApp *app, TCHAR const *section, TCHAR const *entry)
{	_ASSERTE(app!=NULL && section!=NULL && entry!=NULL);
		//
	bool res = false;
	BYTE *pData = NULL;
