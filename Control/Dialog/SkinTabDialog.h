#ifndef _SKINTABDIALOG_H
#define _SKINTABDIALOG_H

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000

// CSkinTabDialog dialog

class CSkinTabDialog : public CDialog
{
public:
	CSkinTabDialog ( UINT nResourceID, CWnd* pParent = NULL );
	~CSkinTabDialog();

	enum	{	CLICKED_BOX_NONE = 0,
				CLICKED_BOX_RESTORE_TAB,
