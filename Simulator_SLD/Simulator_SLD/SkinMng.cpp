...
CString CSkinMng::GetBitmapFileName(UINT nBitmapID)
{
	switch( nBitmapID )
	{
		case IDX_SYSTEMICON_CAPTION_LEFT				:	return _T("Skin\\SLD\\Frame\\System_Caption_Left.pnoimg");						break;
		case IDX_SYSTEMICON_CAPTION_CENTER				:	return _T("Skin\\SLD\\Frame\\System_Caption_Center.pnoimg");					break;
		case IDX_SYSTEMICON_CAPTION_RIGHT				:	return _T("Skin\\SLD\\Frame\\System_Caption_Right.pnoimg");						break;
		case IDX_SYSTEMICON_FRAME_LEFT					:	return _T("Skin\\SLD\\Frame\\System_Frame_Left.pnoimg");						break;
		case IDX_SYSTEMICON_FRAME_LEFT_BOTTOM			:	return _T("Skin\\SLD\\Frame\\System_Frame_LeftBottom.pnoimg");					break;
		case IDX_SYSTEMICON_FRAME_BOTTOM				:	return _T("Skin\\SLD\\Frame\\System_Frame_Bottom.pnoimg");						break;
		case IDX_SYSTEMICON_FRAME_RIGHT					:	return _T("Skin\\SLD\\Frame\\System_Frame_Right.pnoimg");						break;
		case IDX_SYSTEMICON_FRAME_RIGHT_BOTTOM			:	return _T("Skin\\SLD\\Frame\\System_Frame_RightBottom.pnoimg");					break;
		case IDX_CAPTION_MINIMIZE_ON					:	return _T("Skin\\SLD\\SystemBar\\Caption_Minimize_On.pnoimg");					break;
		case IDX_CAPTION_MINIMIZE_OFF					:	return _T("Skin\\SLD\\SystemBar\\Caption_Minimize_Off.pnoimg");					break;
		case IDX_CAPTION_MINIMIZE_DOWN					:	return _T("Skin\\SLD\\SystemBar\\Caption_Minimize_Down.pnoimg");				break;
		case IDX_CAPTION_MINIMIZE_DISABLE				:	return _T("Skin\\SLD\\SystemBar\\Caption_Minimize_Disable.pnoimg");				break;
		case IDX_CAPTION_MAXIMIZE_ON					:	return _T("Skin\\SLD\\SystemBar\\Caption_Maximize_On.pnoimg");					break;
		case IDX_CAPTION_MAXIMIZE_OFF					:	return _T("Skin\\SLD\\SystemBar\\Caption_Maximize_Off.pnoimg");					break;
		case IDX_CAPTION_MAXIMIZE_DOWN					:	return _T("Skin\\SLD\\SystemBar\\Caption_Maximize_Down.pnoimg");				break;
		case IDX_CAPTION_MAXIMIZE_DISABLE				:	return _T("Skin\\SLD\\SystemBar\\Caption_Maximize_Disable.pnoimg");				break;
		case IDX_CAPTION_EXIT_ON						:	return _T("Skin\\SLD\\SystemBar\\Caption_Exit_On.pnoimg");						break;
		case IDX_CAPTION_EXIT_OFF						:	return _T("Skin\\SLD\\SystemBar\\Caption_Exit_Off.pnoimg");						break;
		case IDX_CAPTION_EXIT_DOWN						:	return _T("Skin\\SLD\\SystemBar\\Caption_Exit_Down.pnoimg");					break;
		case IDX_CAPTION_EXIT_DISABLE					:	return _T("Skin\\SLD\\SystemBar\\Caption_Exit_Disable.pnoimg");					break;
		case IDX_CAPTION_RESTORE_ON						:	return _T("Skin\\SLD\\SystemBar\\Caption_Restore_On.pnoimg");					break;
		case IDX_CAPTION_RESTORE_OFF					:	return _T("Skin\\SLD\\SystemBar\\Caption_Restore_Off.pnoimg");					break;
		case IDX_CAPTION_RESTORE_DOWN					:	return _T("Skin\\SLD\\SystemBar\\Caption_Restore_Down.pnoimg");					break;
		case IDX_CAPTION_RESTORE_DISABLE				:	return _T("Skin\\SLD\\SystemBar\\Caption_Restore_Disable.pnoimg");				break;
	}
	return _T("");
}
...
CString CSkinMng::GetIconFileName(UINT nIconID)
{
	switch( nIconID )
	{
		case IDX_ICON_OK							:	return _T("Skin\\SLD\\ok.ico");						break;
	}
	return _T("");
}
