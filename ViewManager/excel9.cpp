...
CString _Application::GetStandardXFont()
{
	CString result;
...
void _Application::SetStandardXFont(LPCTSTR lpszNewValue)
{
	static BYTE parms[] =
		VTS_BSTR;
...
double _Application::GetStandardXFontSize()
{
	double result;
...
void _Application::SetStandardXFontSize(double newValue)
{
	static BYTE parms[] =
		VTS_R8;
...
VARIANT Range::AutoFormat(long Format, const VARIANT& Number, const VARIANT& XFont, const VARIANT& Alignment, const VARIANT& Border, const VARIANT& Pattern, const VARIANT& Width)
{
	VARIANT result;
	static BYTE parms[] =
	...
	InvokeHelper(0x72, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms,
		Format, &Number, &XFont, &Alignment, &Border, &Pattern, &Width);
	return result;
}
...
LPDISPATCH XFont::GetApplication()
{
	LPDISPATCH result;
	InvokeHelper(0x94, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
void XFont::SetBackground(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void XFont::SetBold(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void XFont::SetColor(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
	InvokeHelper(0x63, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
void XFont::SetColorIndex(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
	InvokeHelper(0x61, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
void XFont::SetFontStyle(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void XFont::SetItalic(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void XFont::SetName(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
	InvokeHelper(0x6e, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms,
...
void XFont::SetOutlineXFont(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void XFont::SetShadow(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void XFont::SetSize(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
VARIANT XFont::GetStrikethrough()
{
	VARIANT result;
...
void XFont::SetStrikethrough(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void XFont::SetSubscript(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void XFont::SetSuperscript(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
void XFont::SetUnderline(const VARIANT& newValue)
{
	static BYTE parms[] =
		VTS_VARIANT;
...
LPDISPATCH Shapes::AddTextEffect(long PresetTextEffect, LPCTSTR Text, LPCTSTR XFontName, float XFontSize, long XFontBold, long XFontItalic, float Left, float Top)
{
	LPDISPATCH result;
	static BYTE parms[] =
	...
	InvokeHelper(0x6c0, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms,
		PresetTextEffect, Text, XFontName, XFontSize, XFontBold, XFontItalic, Left, Top);
	return result;
}
