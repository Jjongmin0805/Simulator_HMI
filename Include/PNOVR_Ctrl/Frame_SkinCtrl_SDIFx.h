...
// CFrame_SkinCtrl_SDIFx 프레임입니다.

class AFX_EXT_CLASS CFrame_SkinCtrl_SDIFx : public CFrameWndEx
{
	DECLARE_DYNCREATE(CFrame_SkinCtrl_SDIFx)
protected:
	CFrame_SkinCtrl_SDIFx();           // 동적 만들기에 사용되는 protected 생성자입니다.
	virtual ~CFrame_SkinCtrl_SDIFx();
...
protected:
	void																					SetDefaultSize( CSize sizeOffSet = CSize( 0, 0 ) );
	void																					SetskinIMGsize();
	void																					DrawFrame();
