...
// 	m_iTime = time;
// 	// 
// 	if(CWnd::Create(CCtrl_TabWnd_Tools::RegisterWndClass(_T("Timer")),_T(""),WS_CHILD,CRect(0,0,0,0),CWnd::GetDesktopWindow(),100)==0 ||
...
// 
// protected:
// 	static void CALLBACK TimeProc(UINT /*uID*/, UINT /*uMsg*/, DWORD dwUser, DWORD_PTR /*dw1*/, DWORD /*dw2*/)
// 	{
...
{	bool Wait()
{	if(CWnd::Create(CCtrl_TabWnd_Tools::RegisterWndClass(_T("PaintFinishWaiter")),_T(""),WS_CHILD,
