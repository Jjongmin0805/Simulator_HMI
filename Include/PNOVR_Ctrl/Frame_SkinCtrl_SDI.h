...
// CFrame_SkinCtrl_SDI 프레임입니다.

class AFX_EXT_CLASS CFrame_SkinCtrl_SDI : public CFrameWnd
{
	DECLARE_DYNCREATE(CFrame_SkinCtrl_SDI)
protected:
	CFrame_SkinCtrl_SDI();           // 동적 만들기에 사용되는 protected 생성자입니다.
	virtual ~CFrame_SkinCtrl_SDI();
