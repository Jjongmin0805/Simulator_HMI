...
struct tagCtrl_EditValue
{
	tagCtrl_EditValue() : nRow( 0 ), nCol( 0 ), nUpdate( 0 ), nUnitIdx( 0 )
	{
		//
	};
...
public:
	...
	void SendParentMsgData( int nRow, int nCol, int nUpdate );
	CString GetOldEditValue()					  { return m_szOldEditValue; };
...
///////////////////////////////////////////////////////////////////////////////////
// 	//20171218 Ãß°¡
 	void																						MoveItemData( int nRow, int nCol, BOOL bForceRedraw = TRUE );
	BOOL																						FindItemData();
	void																						SetSortCol( BOOL bAscending );

	CGridCtrl_FindDLG*				m_pFindWnd;
...
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
	afx_msg LRESULT OnFindDlgSendMSGdata( WPARAM wParam, LPARAM lParam );
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
