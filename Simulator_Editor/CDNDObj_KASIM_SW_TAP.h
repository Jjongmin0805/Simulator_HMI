...
class CDNDObj_KASIM_SW_TAP : public CDialog
{
	DECLARE_DYNAMIC(CDNDObj_KASIM_SW_TAP)

public:
	CDNDObj_KASIM_SW_TAP(CWnd* pParent = nullptr);   // 표준 생성자입니다.
	virtual ~CDNDObj_KASIM_SW_TAP();

// 대화 상자 데이터입니다.
#ifdef AFX_DESIGN_TIME
	enum {		IDD = IDD_DNDOBJECT_TPA_KASIM_SW_DLG };
#endif
