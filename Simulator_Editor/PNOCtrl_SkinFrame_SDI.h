...
// CPNOCtrl_SkinFrame_SDI 프레임입니다.

class CPNOCtrl_SkinFrame_SDI : public CFrameWnd
{
	DECLARE_DYNCREATE(CPNOCtrl_SkinFrame_SDI)
protected:
	CPNOCtrl_SkinFrame_SDI();           // 동적 만들기에 사용되는 protected 생성자입니다.
	virtual ~CPNOCtrl_SkinFrame_SDI();
